...
// IMPORTANTE: Coloque termos específicos no TOPO para eles terem prioridade!
const CATEGORY_STYLE: Record<string, { emoji: string; bg: string }> = {
  // 1. Termos ultra-específicos (Match no Título)
  ...
  // 3. Categorias Gerais (Fallback - Se nada acima der match, cai aqui)
...
function getCategoryStyle(category: string, title: string) {
  ...
  // Percorre as chaves na ordem que foram definidas acima
      ...
      <section className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 pt-20 pb-16 relative">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-6xl lg:text-7xl leading-[1.05] text-cream">Hoje você pode cozinhar<br /><em className="text-blush font-display italic">{loading ? "…" : `${filtered.length} receitas`}</em> sem ir ao mercado.</h1>
          </div>
